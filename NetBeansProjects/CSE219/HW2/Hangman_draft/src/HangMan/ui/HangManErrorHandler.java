...
public class HangManErrorHandler {
	private Stage ui;
	public HangManErrorHandler(Stage initUI){
		ui = initUI;
	}
     ...
     */
    public void processError(HangManPropertyType errorType)
    {
        ...
        String errorTitle = props.getProperty(HangManPropertyType.ERROR_DIALOG_TITLE_TEXT);
